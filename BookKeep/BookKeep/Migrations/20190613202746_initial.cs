    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TravelLocations", x => x.LocationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Locations_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_User_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(nullable: false),
                    NightVentures = table.Column<int>(nullable: false),
                    FoodVentures = table.Column<int>(nullable: false),
                    ArtandCultureVentures = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interests_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Spent = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTrips", x => x.TripId);
                    table.ForeignKey(
                        name: "FK_UserTrips_TravelLocations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "TravelLocations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripPlans", x => x.PlanId);
                    table.ForeignKey(
                        name: "FK_TripPlans_UserTrips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_Locations_CityId",
                table: "User_Locations",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrips_LocationId",
                table: "UserTrips",
                column: "LocationId");
